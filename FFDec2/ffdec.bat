...
if "%FFDEC_MEMORY%"=="" set FFDEC_MEMORY=2048m
...
..\jdk-17.0.2\bin\java %MEMORY_PARAM% %STACK_SIZE_PARAM% -Djava.net.preferIPv4Stack=true -Djna.nosys=true -Djava.util.Arrays.useLegacyMergeSort=true -jar "%~dp0\ffdec.jar" %*
